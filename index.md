...
address: "Babbidge Library, Room 1001"      # full street address of workshop (e.g., "Room A, 123 Forth Street, Blimingen, Euphoria")
...
humandate: "Spring 2018"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
humantime: "2-4 PM"    # human-readable times for the workshop (e.g., "9:00 am - 4:30 pm")
...
email: ["renee.walsh@uconn.edu"]    # boxed, comma-separated list of contact email addresses for the host, lead instructor, or whoever else is handling questions, like ["marlyn.wescoff@example.org", "fran.bilas@example.org", "ruth.lichterman@example.org"]
